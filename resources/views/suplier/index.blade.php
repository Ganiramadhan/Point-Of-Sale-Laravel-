                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    ...
                                                                    <input type="hidden"
                                                                        ...
                                                                        {{-- placeholder="Generate Otomatis" readonly --}} value="{{ $a->id_suplier }}"
                                                                        name="id" id="id" />
                                                                    {{-- </div> --}}
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            placeholder="Nama Cabang" name="nama_suplier"
                                                                            id="nama_suplier"
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            id="alamat_suplier"
                                                                            value="{{ $a->alamat_suplier }}" required />
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <input type="hidden" class="form-control form-control-solid"
                                                    {{-- placeholder="Generate Otomatis" readonly --}} value="{{ 'SPL' . rand(00, 99) * 30 }}"

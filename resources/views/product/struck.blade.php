    ...
    <center>
        <table style='width:550px; font-size:8pt; font-family:calibri; border-collapse: collapse;' border='0'>
            <td width='70%' align='left' style='padding-right:80px; vertical-align:top'>
                <span style='font-size:12pt'><b>GaniSTORE</b></span></br>
                Jl.Dadap Baru, No.45, Juntinyuat, Indramayu Jawabarat 40123
                </br>
                Telp : 0838788277182
            </td>
        ...
        <table style='width:550px; font-size:8pt; font-family:calibri; border-collapse: collapse;' border='0'>
            <td width='70%' align='left' style='padding-right:80px; vertical-align:top'>
                Nama Kasir : {{ $nama }}</br>
                Alamat : Jl.Dadap Baru No 45, Juntinyuat, Indramayu ,Jawa Barat
            </td>
            <td style='vertical-align:top' width='30%' align='left'>

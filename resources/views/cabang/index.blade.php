                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <input type="hidden" class="form-control form-control-solid"
                                                    {{-- placeholder="Generate Otomatis" readonly --}} value="{{ 'CBG' . rand(00, 99) * 30 }}"
                                                    name="id_cabang" id="id_cabang" />
                                                {{-- <span class="form-text text-muted">Diisi Otomatis</span>
                                                    </div>
                                                </div> --}}
                                                <div class="col-md-12">
                                                    <div class="form-group">
